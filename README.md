...
For example, the following command will print out all possible double with DS='0', DE='1', and max length of 4. <br/><br/>
`./pa08 -D 0 1 4` <br/> 
...
For example, the following command will print out all possible identifers with LCS='a', LCE='b', UCS='C',UCE='D', DS='0', DE='1', and max length of 2. <br/><br/>
